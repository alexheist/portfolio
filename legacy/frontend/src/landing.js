...
function Elevator() {
  return (
    <div id="elevator">
      <p>
        There’s beauty in simplicity, but chaos is cathartic. I work with
        startups and small businesses building the web applications to help them
        succeed. I began writing software in 2016, and since then have developed
        in many different languages for both personal and professional projects.
      </p>
    </div>
  );
}
  ...
  handleSubmit(event) {
    ...
    let clearForm = () => {
      ...
      if (window.innerWidth > 768) {
        document
          .getElementById("name-label")
          .setAttribute("style", "color:#656565;");
        document
    ...
    window.grecaptcha.ready(function() {
      window.grecaptcha
        .execute(process.env.REACT_APP_RECAPTCHA, { action: "homepage" })
        .then(function(token) {
      ...
      <form id="contact" onSubmit={this.handleSubmit}>
        ...
        <div id="message-field">
          ...
          <textarea
            ...
            rows="10"
            cols="50"
            onChange={() => this.handleChange("message-label")}
          />
        </div>
